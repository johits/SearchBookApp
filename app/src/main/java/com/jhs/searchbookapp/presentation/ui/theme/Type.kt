package com.jhs.searchbookapp.presentation.ui.theme
...
internal val Typography = SearchBookAppTypography(
...
@Immutable
data class SearchBookAppTypography(
